...
const Filter = () => {
  return (
    <div className="absolute w-44 z-10  bg-white border rounded-md shadow-md top-[560px] right-[290px]">
      <div className="px-5 py-3">
        ...
        <p className="pt-5 font-bold pb-2 text-blue-500">Terbit</p>
        <ul className="pb-5 text-[17px] ">
          <li className="hover:scale-105">
            <Link className="text-slate-500 font-semibold" to={"/2010"}>
              <div
                className="h-4 w-4 rounded-full bg-slate-300 border inline-block 
             "
              ></div>
              <span className="pl-3 ">2010 {">"}</span>
            </Link>
          </li>
          <li className="hover:scale-105">
            <Link className="text-slate-500 font-semibold">
              <div
                className="h-4 w-4 rounded-full bg-slate-300 border inline-block 
             "
              ></div>
              <span className="pl-3">2015 {">"}</span>
            </Link>
          </li>
          <li className="hover:scale-105">
            <Link className="text-slate-500 font-semibold">
