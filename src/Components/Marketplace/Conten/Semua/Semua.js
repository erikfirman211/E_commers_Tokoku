  ...
  return (
    <div className="h-[1000px] ">
      ...
      <div className="container max-w-6xl rounded-lg lg:pt-20 mx-auto">
        <Hero1 />
        <div className="pt-10  ">
          <p className="px-10 py-5 font-semibold text-2xl">Penjualan</p>
          <div className="flex justify-between ">
            <div className="flex flex-wrap gap-5 p-2 justify-center w-10/12 ">
              {products.map((product) => (
                ...
                >
                  <img
                    ...
                    alt="img"
                  />
                  <p className="text-[10px] font-semibold py-1">
                    {product.name}
                  </p>
                  <div className="flex justify-between">
